(function ($) {
  ...
  if (pbmit_text.length) {
    $(
      "<div id='pbmit-cursor'><div class='pbmit-tooltip-content'></div></div>"
    ).appendTo("body");
  ...
  /*-------------------------------------
    Active Hover
    -------------------------------------*/
  $(".active-onhover .pbmit-ihbox-style-24:nth-child(2)").addClass(
    "pbmit-mihbox-hover-active"
  );

  $(".active-onhover .pbmit-ihbox-style-24")
    .mouseover(function () {
      var main_row = $(this).closest(".active-onhover");
      $(".pbmit-ihbox-style-24", main_row).removeClass(
        "pbmit-mihbox-hover-active"
      );
    ...
    .mouseout(function () {
      ...
      $(".pbmit-ihbox-style-24:nth-child(2)", main_row).addClass(
        "pbmit-mihbox-hover-active"
      );
    });
  ...
  $(".main-menu ul.navigation li.dropdown").append(
    "<span class='righticon'><i class='pbmit-base-icon-down-open-big'></i></span>"
  );
  ...
  $(".main-menu ul.navigation li.dropdown .righticon").on("click", function () {
    ...
    $(this)
      .find("i")
      .toggleClass("pbmit-base-icon-down-open-big pbmit-base-icon-up-open-big");
    return false;
  });
